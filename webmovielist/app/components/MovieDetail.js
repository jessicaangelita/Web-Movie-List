  ...
  return (
    <div className='p-10 m-5'>
        ...
        <div className='flex my-5'>
            <div>
                <Image src={details.medium_cover_image} width={300} height={345} className='rounded-lg  drop-shadow-xl my-5  shadow-xl' alt='temp'/>
                <Link href={'https://www.youtube.com/watch?v='+details.yt_trailer_code}><button className='bg-green-800 rounded-lg p-3 text-orange-100 font-medium w-full hover:bg-green-700 mb-5' >Watch Trailer</button></Link>
                <button className='bg-orange-200 rounded-lg p-3 text-green-800 font-medium w-full hover:bg-orange-300' >Buy Tickets</button>
            </div>
            <div className='p-5 mx-5 w-4/5'>
                ...
                <p className='font-medium text-justify'>{details.synopsis}</p>
            </div>
        </div>
    </div>
  )
