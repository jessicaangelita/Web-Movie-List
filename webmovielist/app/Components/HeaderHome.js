    ...
    return (
        <header className=" body-font w-full">
            <div className="flex flex-wrap mx-auto p-8 flex-col md:flex-row items-center bg-green-800 ">
                ...
                className="inline-flex items-center bg-orange-200 border-0 py-2 px-4 focus:outline-none hover:bg-orange-300 rounded-lg text-base mt-4 md:mt-0 font-medium">Sign Out
